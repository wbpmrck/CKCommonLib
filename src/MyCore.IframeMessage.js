...
依赖： 无
使用说明：用于提供跨frame通信的能力
-----------
版本历史：
by kaicui 2012-10-31 14:52:43      版本创建
//////////////////////////////////////////////////////////////////*/
...
MyCore.IframeMessage = (function (my) {
    ...
    Messenger.prototype.init = function () {
        ...
        var receiver = function (event) {
			...
			//在IE8下，如果从弹出窗口的回调函数中触发此事件，则event.source会是原来的 弹出窗口，而不是当前的win,所以这里还是要注释掉，或可以约定一个编号
			//by kaicui 2013-1-30 13:14:38 
